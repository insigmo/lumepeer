...
export type TranslationKey =
  ...
  | 'terminal.running'
  | 'terminal.ended'
  | 'terminal.refusedHeading'
  | 'terminal.refused.notGranted'
  | 'terminal.refused.tooMany'
  | 'terminal.refused.cannotDropPrivileges'
  | 'terminal.refused.unavailable'
  | 'toolbar.terminal'
  ...
  | 'quality.path.obfuscated'
  | 'quality.transport.iroh'
  | 'quality.transport.obfuscated'
  | 'quality.fallbackLabel'
  | 'quality.fallback.noAnswer'
  | 'quality.fallback.lost'
  | 'quality.fallback.failed'
  | 'quality.rttLabel'
  | 'quality.lossLabel'
