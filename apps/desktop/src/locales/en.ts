...
export const en: Dictionary = {
  ...
  'invite.sessionNotResumed': 'The session could not be resumed. Connect again to ask for a new one.',
  'invite.unreachable':
  ...
  'audit.kind.reboot': 'Restart or shutdown requested',
  'audit.kind.session_resumed': 'Session resumed after a dropped connection',
  ...
  'fileManager.heading': 'File manager',
  'fileManager.local': 'This computer',
  'fileManager.remote': 'Remote computer',
  'fileManager.up': 'Up',
  'fileManager.loading': 'Loading…',
  'fileManager.empty': 'This folder is empty.',
  'fileManager.truncated': 'Only the first entries are shown — this folder has more in it.',
  'fileManager.localUnreadable': 'That folder on this computer could not be opened.',
  'fileManager.folder': 'Folder',
  'fileManager.download': 'Download',
  'fileManager.upload': 'Upload',
  'fileManager.refused.notGranted': 'The host has not allowed browsing its files.',
  'fileManager.refused.badPath': 'The host will not open that path.',
  'fileManager.refused.unreadable': 'That folder could not be read on the host.',
  'fileManager.download.notGranted': 'The host has not allowed files to be taken from it.',
  'fileManager.download.badPath': 'The host will not send a file from that path.',
  'fileManager.download.unreadable': 'That file could not be read on the host.',
  'fileManager.download.tooMany': 'Too many downloads at once — wait for one to finish.',
  ...
  'tunnel.active': 'Forwarding',
  'tunnel.streams': (arg) => `${arg} open`,
  'tunnel.none': 'This guest can reach nothing. Add an address to allow one.',
  'tunnel.addressLabel': 'Address',
  'tunnel.addressPlaceholder': '127.0.0.1:8080',
  'tunnel.allow': 'Allow',
  'tunnel.deny': 'Remove',
  'tunnel.closeAll': 'Close all',
  'tunnel.badAddress': 'That is not an address this build will forward to.',
  'terminal.heading': 'Terminal',
  'terminal.close': 'Close',
  'terminal.idle': 'No shell running',
  'terminal.opening': 'Asking the host for a shell…',
  'terminal.running': 'A shell is running on the host',
  'terminal.ended': 'The shell ended.',
  'terminal.refusedHeading': 'The host refused',
  'terminal.refused.notGranted': 'This session may not start a shell on the host.',
  'terminal.refused.tooMany': 'This session already holds as many shells as it may. Close one and ask again.',
  'terminal.refused.cannotDropPrivileges': 'The host could not run the shell as the person sitting at that machine, and would not run it as anyone else.',
  'terminal.refused.unavailable': 'The host has no shell to run.',
  ...
  'quality.path.obfuscated': 'Obfuscated direct',
  'quality.transport.iroh': 'Standard',
  'quality.transport.obfuscated': 'Obfuscated',
  'quality.fallbackLabel': 'Switched from',
  'quality.fallback.noAnswer': (transport) => `${transport} — nothing answered`,
  'quality.fallback.lost': (transport) => `${transport} — the connection dropped`,
  'quality.fallback.failed': (transport) => `${transport} — did not connect`,
  ...
  'resume.waiting.title': 'The connection dropped',
  'resume.waiting.body': 'Getting this session back. It keeps the rights it had; nobody is asked again.',
  'resume.waiting.cancel': 'Stop reconnecting',
  ...
  'agent.indicator': 'Remote access is active on this computer',
};
