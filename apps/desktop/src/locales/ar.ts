...
export const ar: Dictionary = {
  ...
  'invite.sessionNotResumed': 'تعذّر استئناف الجلسة. اتصل مجددًا لطلب جلسة جديدة.',
  'invite.unreachable':
  ...
  'audit.kind.reboot': 'طُلبت إعادة التشغيل أو إيقاف التشغيل',
  'audit.kind.session_resumed': 'استُؤنفت الجلسة بعد انقطاع الاتصال',
  ...
  'status.noCapture.chromeos':
    'يعمل هذا الجهاز بنظام Linux داخل ChromeOS، ولا تستطيع التطبيقات هناك رؤية شاشة ChromeOS، لذلك لن يرى من تدعوه أي صورة. يظل الاتصال من هنا بالأجهزة الأخرى يعمل كالمعتاد.',
  'status.noEncoder':
  ...
  'view.unavailable.captureDenied':
    'لم يسمح نظام الجهاز الآخر لـ Lumepeer بتسجيل شاشته. يجب على شخص عند ذلك الجهاز السماح لـ Lumepeer بتسجيل الشاشة، ثم يمكنك الاتصال مجددًا. الاتصال نفسه سليم.',
  ...
  'terminal.heading': 'الطرفية',
  'terminal.close': 'إغلاق',
  'terminal.idle': 'لا توجد صدفة قيد التشغيل',
  'terminal.opening': 'يجري طلب صدفة من المضيف…',
  'terminal.running': 'توجد صدفة قيد التشغيل على المضيف',
  'terminal.ended': 'انتهت الصدفة.',
  'terminal.refusedHeading': 'رفض المضيف',
  'terminal.refused.notGranted': 'لا يُسمح لهذه الجلسة ببدء صدفة على المضيف.',
  'terminal.refused.tooMany': 'لدى هذه الجلسة بالفعل العدد المسموح به من الصدفات. أغلق واحدة ثم اطلب مرة أخرى.',
  'terminal.refused.cannotDropPrivileges': 'لم يتمكن المضيف من تشغيل الصدفة بصلاحيات الشخص الجالس أمام ذلك الجهاز، ولم يشغّلها بصلاحيات أي شخص آخر.',
  'terminal.refused.unavailable': 'لا توجد لدى المضيف صدفة يمكن تشغيلها.',
  ...
  'quality.path.obfuscated': 'اتصال مباشر مموّه',
  'quality.transport.iroh': 'قياسي',
  'quality.transport.obfuscated': 'مموّه',
  'quality.fallbackLabel': 'تم التبديل من',
  'quality.fallback.noAnswer': (transport) => `${transport}: لا استجابة`,
  'quality.fallback.lost': (transport) => `${transport}: انقطع الاتصال`,
  'quality.fallback.failed': (transport) => `${transport}: تعذّر الاتصال`,
  ...
  'reboot.banner.reboot': (peer) => `${peer} يطلب إعادة تشغيل هذا الحاسوب`,
  'reboot.banner.shutdown': (peer) => `${peer} يطلب إيقاف تشغيل هذا الحاسوب`,
  'reboot.banner.countdown': (secs) => `سيحدث ذلك خلال ${secs} ثانية ما لم توقفه.`,
  'reboot.banner.cancel': 'أبقِ هذا الحاسوب مشغّلاً',
  'reboot.ask.reboot': 'إعادة تشغيل المضيف',
  'reboot.ask.shutdown': 'إيقاف تشغيل المضيف',
  'reboot.ask.shutdownWarning': 'سيبقى المضيف متوقفاً حتى يشغّله أحد بنفسه، ولن تتمكن من الاتصال به مرة أخرى.',
  ...
  'resume.waiting.title': 'انقطع الاتصال',
  'resume.waiting.body': 'تجري استعادة هذه الجلسة. تحتفظ بالصلاحيات التي كانت لها، ولن يُسأل أحد مجددًا.',
  'resume.waiting.cancel': 'إيقاف إعادة الاتصال',
