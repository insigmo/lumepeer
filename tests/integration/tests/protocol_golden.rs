...
//!
//! The vectors in `tests/interop/golden_vectors.txt` are frozen for
//! `PROTOCOL_MINOR` 0: an interop partner that passes today must keep passing.
//! Changing one means bumping the minor version.
//!
